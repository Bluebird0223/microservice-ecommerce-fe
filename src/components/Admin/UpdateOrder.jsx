        ...
        <>
            {order && (
                <div className="flex flex-col gap-4">
                    <Link to="/admin/orders" className="ml-1 flex items-center gap-0 font-medium text-blue-700 uppercase"><ArrowBackIosIcon sx={{ fontSize: "18px" }} />Go Back</Link>

                    <div className="flex flex-col sm:flex-row bg-white shadow-lg rounded-lg min-w-full text-gray-700">
                        ...
                        <form onSubmit={updateOrderSubmitHandler} className="flex flex-col gap-3 p-8">
                            ...
                            <button type="submit" className="bg-orange-500 p-2.5 text-white font-medium rounded shadow hover:shadow-lg">
                                Update
                            </button>
                        </form>
                    </div>
