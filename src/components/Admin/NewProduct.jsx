...
const NewProduct = () => {
    ...
    return (
        <>
            ...
            <form onSubmit={newProductSubmitHandler} encType="multipart/form-data" className="flex flex-col lg:flex-row bg-white rounded-lg shadow p-4" id="mainform">

                <div className="flex flex-col gap-3 m-2 lg:w-1/2">
                    <TextField
                        label="Name"
                        variant="outlined"
                        size="small"
