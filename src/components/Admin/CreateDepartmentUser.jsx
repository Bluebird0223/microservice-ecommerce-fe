...
const CreateDepartmentUser = () => {
    ...
    const fetchSubcategory = async () => {
        try {
            ...
            enqueueSnackbar("Subcategory not found: " + error.message, { variant: "error" });
        }
    };
    ...
    const fetchCategories = async () => {
        try {
            ...
            enqueueSnackbar("categories not found: " + error.message, { variant: "error" });
        }
    };
    ...
    useEffect(() => {
        fetchSubcategory();
        fetchCategories();
    }, [enqueueSnackbar, fetchSubcategory]);

    return (
        <>
            <MetaData title="Admin: New Department User | Flipkart" />
